...
Butler.prototype.playNext = function (song) {
    this.parse(song.url, (function (parsed) {
        if (parsed !== null) {
            song.url = parsed;
            this.playlist.splice(this.song + 1, 0, song);
            this.notify('added', {song: song, pos: this.song + 1});
        }
    }).bind(this));
};
...
Butler.prototype.queue = function (song) {
    this.parse(song.url, (function (parsed) {
        if (parsed !== null) {
            ...
            this.notify('added', {song: song, pos: this.playlist.length - 1})
        }
    }).bind(this));
};
